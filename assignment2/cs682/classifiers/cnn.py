...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params['W2'] = np.random.normal(0, weight_scale, (input_dim[1] * input_dim[2] * num_filters//4, hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        out2, cache2 = affine_relu_forward(out1.reshape(out1.shape[0],-1), W2, b2)
        ...
        dout, grads['W1'], grads['b1'] = conv_relu_pool_backward(dout1.reshape(out1.shape), cache1)
